...
List<CsvTarget> buildCsvTargets() => [
      const CsvTarget(
        label: 'Destinations',
        table: 'destinations',
        note: 'Bulk-import destinations. destination_id, slug, and a scalable '
            'destination_code are auto-generated by the database when omitted '
            '(needs migration 0020).',
        columns: [
          CsvCol('name', 'Name', required: true),
          CsvCol('destination_type', 'Type (e.g. State Park)'),
          CsvCol('state_province', 'State'),
          CsvCol('county', 'County'),
          CsvCol('city', 'City'),
          CsvCol('region', 'Region'),
          CsvCol('subcategory', 'Subcategory'),
          CsvCol('managing_agency', 'Managing agency'),
          CsvCol('latitude', 'Latitude', number: true),
          CsvCol('longitude', 'Longitude', number: true),
          CsvCol('description', 'Description'),
          CsvCol('website', 'Website'),
          CsvCol('phone', 'Phone'),
          CsvCol('address', 'Address'),
          CsvCol('hero_image', 'Hero image URL'),
        ],
        defaults: {'country': 'USA', 'published': false},
      ),
